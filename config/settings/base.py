"""
Django base settings for CourseCart vocational platform.
"""
import os
...
ALLOWED_HOSTS = ['coursecartt.pythonanywhere.com']
...
LOGIN_REDIRECT_URL = 'profiles:dashboard'  # Redirects to role-based dashboard
LOGOUT_REDIRECT_URL = 'accounts:welcome'   # Back to landing page
